...
const CharacterSelect = () => {
  ...
  const charactersByAnime = {
    ...
    general: [
      ...
      { name: 'Tentacles', image: '/images/characters/tentacles.jpg', isAdult: false },
      { name: 'Tomboy', image: '/images/characters/tomboy.jpg', isAdult: false },
      { name: 'Futanari', image: '/images/characters/futa.jpg', isAdult: false },
      { name: '2girls,girls', image: '/images/characters/girls.jpg', isAdult: false },
      { name: 'mom,little son', image: '/images/characters/momson.jpg', isAdult: false },
      { name: '2girls,milfs', image: '/images/characters/milfs.jpg', isAdult: false },
    ],
  };
