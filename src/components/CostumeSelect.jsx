...
const CostumeSelect = () => {
  ...
  const costumes = [
    ...
    { name: 'Revealing Micro Swimsuit', image: '/images/costume/micro_swimsuit.jpg', isAdult: false },
    ...
    { name: 'Revealing Micro Bikini', image: '/images/costume/micro_bikini.jpg', isAdult: false },
    ...
    { name: 'Thong', image: '/images/costume/thong.jpg', isAdult: false },
    { name: 'Body Foam', image: '/images/costume/foam.jpg', isAdult: false },
    { name: 'Body Cream', image: '/images/costume/cream.jpg', isAdult: false },
